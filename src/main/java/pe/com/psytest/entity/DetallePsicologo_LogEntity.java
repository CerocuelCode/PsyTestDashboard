...
@Entity(name="DetallePsicologo_LogEntity")
@Table(name="DetallePsicologo_Log")
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class DetallePsicologo_LogEntity implements Serializable {
    ...
    private DetallePsicologoEntity detallePsicologo;
